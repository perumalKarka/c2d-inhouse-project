...
<!-- logo upload -->
<div class="modal fade" id="exampleModal-1" tabindex="-1" aria-labelledby="exampleModalLabel" data-backdrop="static" >
    <div class="modal-dialog container-80 requestform-popup-page">
        <div class="row reset-margin ">
                        <div class="col-6"><h2 class= "form-heading">Lorem ipsum dolor sit amet, consetetur </h2></div>
                        <div class="col-6 skip reset-padding align-self-center text-right"><button type="button" class="btn btn-primary skip">Skip</button></div>
        </div>
        ...
        <div class="modal-content requestmodal_content">
            ...
            <div class="modal-header upload-logo border-0 ">
                <button type="button" class="btn btn-primary skip" data-dismiss="modal" >Upload logo</button></div>
        ...
        <div class="modal-content requestmodal_content site-name pb-6">
            <div class="logo-heading">
