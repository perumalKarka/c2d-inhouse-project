...
$(function () {
  ...
  $('.bt-title [data-toggle="tooltip"]').tooltip({
    template:
      '<div class="tooltip audio-tool-tip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
  });
  $('.widget .socialmedia_network li [data-toggle="tooltip"]').tooltip({
    template:
      '<div class="tooltip socialmedia-tool-tip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
  });
  $(
    '.banner-right-col.overlap-group .plushover-icon[data-toggle="tooltip"]'
  ).tooltip({
    template:
      '<div class="tooltip plushover-tool-tip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
  });
});
...
$(document).ready(function () {
  ...
  $(".teamMember-lists")
    .on("initialized.owl.carousel changed.owl.carousel", function (e) {
      ...
      $(".teamMember-lists .owl-prev").after(
        "<span class='counter'>" + carouselLength + "</span>"
      );
    })
    .owlCarousel({
      loop: true,
      ...
      nav: true,
      navText: [
        "<img src='images/testimonial-next.png'>",
        "<img src='images/testimonial-prev.png'>",
      ],
      autoWidth: true,
      autoHeight: true,
      responsiveClass: true,
  ...
  function fixtitleHeight() {
    ...
    if (jQuery(window).width() < 991) return false;
    jQuery(".landing-body .landing-body--lists").each(function ($) {
      if (jQuery(this).height() > Landingheight) {
        Landingheight = jQuery(this).height();
      }
    });

    jQuery(".service .service-title").height(Titleheight);
    jQuery(".service-body .service-body--lists").height(Bodyheight);
    jQuery(".landing-body .landing-body--lists").height(Landingheight);
  }
...
$(document).on("click", ".banner-left-col a[href^=\\#]", function () {
  $("html, body").animate(
    {
      scrollTop: $('section[data-target="' + this.hash.slice(1) + '"]').offset()
        .top,
    },
    1000
  );
...
$(document).ready(function () {
  ...
  $(".page-home .rectangle-151").on("click", function (event) {
    ...
    if (
      $(".page-home .rectangle-151 .searchhoverPopup").css("display") == "none"
    ) {
      searchBar
        .css({
          display: "block",
  ...
  $(".page-home .rectangle-152").click(function (e) {
    ...
    if (
      $(".page-home .rectangle-152 .searchhoverPopup").css("display") == "none"
    ) {
      searchBar
        .css({
          display: "block",
  ...
  if (supportsAudio) {
    ...
    var index = 0,
      ...
      buildPlaylist = $.each(tracks, function (key, value) {
        ...
        $("#plList").append(
          '<li class="track-block all reggae"> \
            ...
            '</span>\
                      ...
                      <li>\
                        ...
                        <span class="track-time-stamp">' +
            trackDuration +
            '</span>\
                      </li>\
                      <li>\
                        <a href="javascript:void(0)" class="trackadd-btn" data-trackname="' +
            trackName +
            '">Add</a>\
                      </li>\
                  </ul>\
